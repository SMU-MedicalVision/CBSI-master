...
from Networks.UNet_DDPM import Unet
import SimpleITK as sitk
from perceive_loss.pytorch_loss_function import VGGLoss_2D
import numpy as np
...
class GaussianDiffusion(nn.Module):
    def __init__(
        ...
        if loss_type == 'vgg' or loss_type == 'mix':
            self.vggloss = VGGLoss_2D("./perceive_loss/vgg19-dcbb9e9d.pth")
